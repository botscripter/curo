...
/**
 * Curo variable initialization plugin
 * This process engine plugin calls `CamundaVariableHelper.initVariables` on all classes which have [@EnableInitCamundaVariables][EnableInitCamundaVariables] present.
 */
class VariableInitPlugin(
    val context: ConfigurableApplicationContext
) : AbstractProcessEnginePlugin() {

    private val logger: Logger = LoggerFactory.getLogger(VariableInitPlugin::class.java)
