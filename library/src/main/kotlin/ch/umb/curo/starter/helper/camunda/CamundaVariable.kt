 ...
 */
class CamundaVariable<T : Any> constructor(override val variableName: String, private val internalType: KClass<T>) :
     ...
     */
    constructor(variableName: String, type: Class<T>) : this(variableName, type.kotlin)
}
